...
class __TwigTemplate_6b816ee71517a7ba79c05a19f0a1bfd0 extends Template
{
...
";
    ...
    <!--begin::Third Party Plugin(OverlayScrollbars)-->
    <script
      src=\"{{ base_path }}/assets/adminlte/js/overlayscrollbars.browser.es6.min.js\">
      </script>
    <!--end::Third Party Plugin(OverlayScrollbars)-->
    <!--begin::Required Plugin(popperjs for Bootstrap 5)-->
    <script
      src=\"{{ base_path }}/assets/adminlte/js/popper.min.js\">
    </script>
    <!--end::Required Plugin(popperjs for Bootstrap 5)-->
    <!--begin::Required Plugin(Bootstrap 5)-->
    <script
      src=\"{{ base_path }}/assets/adminlte/js/bootstrap.min.js\">
    </script>
    <!--end::Required Plugin(Bootstrap 5)--><!--begin::Required Plugin(AdminLTE)-->
    <script src=\"{{ base_path }}/assets/adminlte/js/adminlte.js\"></script>
    <!--end::Required Plugin(AdminLTE)-->
    <!--begin::OverlayScrollbars Configure-->
    <script src=\"{{ base_path }}/assets/adminlte/js/scrollbar-theme.js\"></script>
    <!--end::OverlayScrollbars Configure-->
    <!-- OPTIONAL SCRIPTS -->
    <!-- apexcharts -->
    <script
      src=\"{{ base_path }}/assets/adminlte/js/apexcharts.min.js\">
    </script>
</html>
", "partials/footer.twig", "C:\\wamp64\\www\\dashboard\\templates\\pages\\partials\\footer.twig");
    }
}
